    ...
    >
      ...
      >
        <path
          ...
          className="fill-gray-200 dark:fill-gray-700 group-hover:fill-gray-300 dark:group-hover:fill-gray-600 transition-colors"
        />
        ...
        <path
          ...
          className="fill-gray-300 dark:fill-gray-600 group-hover:fill-gray-400 dark:group-hover:fill-gray-500 transition-colors"
        />
        <path
        ...
        <rect
            ...
            width="210"
            height="20"
            className="fill-primary/90 group-hover:fill-primary transition-colors"
        />
      </svg>
      <div className="absolute inset-0 flex items-center justify-center -translate-y-1">
        <div className="flex items-center gap-2 text-primary-foreground text-xl font-bold">
